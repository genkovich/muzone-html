        ...
        function create_nice_select($select) {
            $select.after($('<div></div>')
                ...
                .html($select.attr('multiple') 
                    ? 
                        '<div class="title-select"><span class="current"></span><svg><use xlink:href="' + target + '/img/icons.svg#arrow"/></svg></div><ul class="list"></ul>' 
                    : 
                        '<div class="title-select"><span class="current"></span><svg><use xlink:href="' + target + '/img/icons.svg#arrow"/></svg></div><ul class="list"></ul>'
                    )
            );
            ...
            if ($select.attr('multiple')) {
                ...
                $selected.each(function() {
                    ...
                    // $selected_html += '<span class="val">' + $selected_text + '</span>';
                    $selected_html += (`<span class="val" data-id=${attrValue}> ${text}<span class="comma">,</span></span>`);
                });
